...
**[v0.1.3](https://github.com/stoatworks-labs/macroblock/releases/tag/v0.1.3)** — prebuilt for macOS, Windows and Linux. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`macroblock-0.1.3-macos-universal.dmg`](https://github.com/stoatworks-labs/macroblock/releases/download/v0.1.3/macroblock-0.1.3-macos-universal.dmg) | 221 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`macroblock-0.1.3-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/macroblock/releases/download/v0.1.3/macroblock-0.1.3-windows-x86_64-setup.exe) | 219 KB |
